    ...
    public function run()
    {
      ...
      <li>2 этаж- хозяйская спальня с просторной ванной комнатой, две спальни, ванная. Мансарда - кабинет, детская игровая, с/у.&nbsp;</li>
                  ...
                  array (
                      ...
                      'price' => '300000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<p>&nbsp;Ново-рижское шоссе, деревня Падиково, новый элитный поселок на ареду с развитой инфрапструктурой. В домах имеется 4 спальни, каминный зал в два света, кабинет. Современный дизайн, новая мебель.</p>',
                      'featured_image' => 'moy-dom-a1c955893ce582e9e6ccb8920ca5aef0',
                  ),
                  2 =>
                  array (
                      ...
                      'price' => '24500000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<p>Рублево-Успенское шоссе, 4 км от МКАД.</p>
      ...
      <p>Тауны в Раздорах под чистовую. 350м, участок 5 соток. 24 500 000 руб ( торг)</p>',
                  ...
                  array (
                      ...
                      'price' => '17000000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<p>Информация&nbsp;по объекту &laquo;Дуплексы в к/п &laquo;Маленькая Италия&raquo;.</p>
      ...
      &nbsp;</p>',
                  ...
                  array (
                      ...
                      'price' => '3500000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<p>Рублево-Успенское шоссе, 6 км от МКАД, ОКП Жуковка.&nbsp;&nbsp;Кирпичный современный особняк 700м, лесной участок 15 соток( собственность). Индивидуальный проект и дизайн, дорогая качественная отделка. Имеется 4 спальни со своими сан узлами и гардеробными. Три этажа. На первом этаже- студио 150м, высота потолков 4.5 м. Плавательный бассейн 10м с зоной СПА. Полноценный цокольный этаж с бильярдной, домашним кинотеатром. Система &laquo; умный дом&raquo;, центральные коммуникации. Имеется отдельно стоящий гараж на 4 машины с квартирой для персонала, зимняя беседка с барбекю. цена- 3 500 000 $</p>',
                      'featured_image' => 'moy-dom-a1c955893ce582e9e6ccb8920ca5aef0',
                  ),
                  5 =>
                  array (
                      ...
                      'price' => '550000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<p>Рублево-Успенское шоссе, 8 км от МКАД. Элитный поселкок на берегу реки.</p>
      ...
      <p>&nbsp;Новая&nbsp; Цена- 2 300&nbsp;000$</p>',
                  ...
                  array (
                      ...
                      'price' => '9600000',
                      'address' => 'Не забудьте внести адрес объекта',
                      'description' => '<table style="width:292.5pt">
      <tbody>
      <tr>
      ...
      Канализация: Центральная</p>
                  ...
                  'description' => '<p>В элитном поселке ГОРКИ-8 продается дом общей площадью 780 кв.м., кирпично-монолитный (стена 64см.) с возможностью перепланировки. Электричество 40кВт, газ, центральное водоснабжение, центральная канализация (3 куб./сутки) участок 30 соток.<br />

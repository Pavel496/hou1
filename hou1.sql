...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Май 01 2018 г., 14:15
...
(12, 3, 0, 'Hill View Homes', 'hill-view-homes', '7', 'Sale', '55,000', 'Albuquerque, NM, USA', '35.0853336', '-106.60555340000002', '3', '4', '1', '980', '900', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\\\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'Gym,Front yard,Pool,Roof Deck,Balcony Gym,Balcony ,Air Conditioning,Swimming Pool,Central Heating,Laundry Room,Alarm', 'hill-view-homes-e229e8f706916fc3170a2d4c5b3ce643', 'hill-view-homes-75814fed4d5deba066ed87f5095b1d4d', '<iframe width=\\\"560\\\" height=\\\"315\\\" src=\\\"https://www.youtube.com/embed/nmswM1EH1_s?rel=0&showinfo=0\\\" frameborder=\\\"0\\\" allow=\\\"autoplay; encrypted-media\\\" allowfullscreen></iframe>', 1, '2018-02-09 02:52:29', '2018-05-01 02:38:49'),
(13, 1, 0, 'Их дом', 'ikh-dom', '2', 'Sale', '100', 'ффф', '55.804803160453154', '37.514888346679754', NULL, NULL, NULL, NULL, NULL, 'фффф', 'Gym,Front yard,Pool,Roof Deck,Balcony', 'ikh-dom-164e4c3bcb35e8b2dc1936cded435541', NULL, '', 1, '2018-05-01 02:44:51', '2018-05-01 06:59:01');
...
(59, 12, 'hill-view-homes_4-b.jpg'),
(58, 12, 'hill-view-homes_1460-b.jpg'),
(60, 12, 'hill-view-homes_5763-b.jpg'),
(61, 13, 'ikh-dom_3210-b.jpg');
...
(1, 'Coutry House Realty', 'scriptscode7@gmail.com', 'logo.png', 'favicon.png', 'AIzaSyC3m_TyDp94bKpyOxWzojZgcUXYj8DdbBc', 0, 'Country House Realty Агенство недвижимости', NULL, '', '', 'Copyright © 2018 Country House Realty. All rights reserved.', 'О нас', 'Наше агентство недвижимости предоставляет услуги по покупке, продаже,\r\nсдаче в аренду недвижимости в Москве и ближнем Подмосковье, в том числе\r\nосуществляет юридическое сопровождение сделок. Мы разрабатываем дизайн интерьеров,\r\nпроизводим благоустройство территорий, осуществляем строительство и ремонт любой сложности.', '', '', 'Оставайтесь на связи', '<ul class=\\\"contact-info\\\">\r\n            <li><i class=\\\"fa fa-map-marker\\\"></i>Real estate script.\r\n9.5 Main Street, CA,USA</li>\r\n            <li class=\\\"phone\\\"><i class=\\\"fa fa-phone\\\"></i>+62-3456-78910</li>\r\n            <li><i class=\\\"fa fa-envelope\\\"></i>info@domain.com</li>\r\n </ul>', 'title_bg.jpg', 'grid', '37.090240', '-95.712891', 'slider', 'rows', 'grid_side', 'grid_side', 9, '<!-- Go to www.addthis.com/dashboard to customize your tools -->\r\n<script type=\"text/javascript\" src=\"//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5942c509e2db8e32\"></script>\r\n<!-- Go to www.addthis.com/dashboard to customize your tools -->\r\n<div class=\"addthis_inline_share_toolbox\"></div>', '<div id=\"disqus_thread\"></div>\r\n<script>\r\n\r\n/**\r\n*  RECOMMENDED CONFIGURATION VARIABLES: EDIT AND UNCOMMENT THE SECTION BELOW TO INSERT DYNAMIC VALUES FROM YOUR PLATFORM OR CMS.\r\n*  LEARN WHY DEFINING THESE VARIABLES IS IMPORTANT: https://disqus.com/admin/universalcode/#configuration-variables*/\r\n/*\r\nvar disqus_config = function () {\r\nthis.page.url = PAGE_URL;  // Replace PAGE_URL with your page\'s canonical URL variable\r\nthis.page.identifier = PAGE_IDENTIFIER; // Replace PAGE_IDENTIFIER with your page\'s unique identifier variable\r\n};\r\n*/\r\n(function() { // DON\'T EDIT BELOW THIS LINE\r\nvar d = document, s = d.createElement(\'script\');\r\ns.src = \'https://divine-home-pro.disqus.com/embed.js\';\r\ns.setAttribute(\'data-timestamp\', +new Date());\r\n(d.head || d.body).appendChild(s);\r\n})();\r\n</script>\r\n<noscript>Please enable JavaScript to view the <a href=\"https://disqus.com/?ref_noscript\">comments powered by Disqus.</a></noscript>\r\n<script id=\"dsq-count-scr\" src=\"//divine-home-pro.disqus.com/count.js\" async></script>', '#', '#', '#', '#', 'О нас', '<p>Наше агентство недвижимости предоставляет услуги по покупке, продаже,</p><p>сдаче в аренду недвижимости в Москве и ближнем Подмосковье, в том числе</p><p>осуществляет юридическое сопровождение сделок. Мы разрабатываем дизайн интерьеров,</p><p>производим благоустройство территорий, осуществляем строительство и ремонт любой сложности.</p><p>Более 15-ти лет на рынке, нас рекомендуют друзьям.</p><p>Основными клиентами являются физические лица, но также оказываем услуги и юридическим лицам.</p><p>Наше кредо - грамотная работа и&nbsp; конфиденциальность, гибкость&nbsp; к внешним условиям и их изменению.</p><p>Будем рады сотрудничеству!</p>', '55.805261', '37.515228', 'Контакты', 'admin@admin.com', '+12-3456-78910', 'Real estate script. 9.5 Main Street, CA,USA', '', '', '', '', '$', 'USD', 9.99, '<div><span style=\"font-weight: bold;\">Bank payment details</span></div><div><br></div><div>ICICI: 38082 01288916</div><div>SWIFT: ICICINBBTSY</div><div><br></div><div>Featured property price: 10 USD</div><div><br></div>');

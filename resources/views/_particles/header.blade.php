      ...
      <div class="menu-container col-xs-6 col-sm-8 col-md-9">
                ...
                <nav id="main-menu" class="hidden-xs hidden-sm">
                    <ul class="main-menu list-inline">
                        <li><a style="font-size:22px" href="{{ URL::to('/') }}" class="{{classActivePathPublic('')}}">Все объекты</a></li>
                        ...
                        <li class="dropdown">
                          <a style="font-size:22px" class="dropdown-toggle {{classActivePathPublic('house')}}" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="true">Дома</a>
                        ...
                        <li class="dropdown">
                          <a style="font-size:22px" class="dropdown-toggle {{classActivePathPublic('apartment')}}" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="true">Квартиры</a>
                          <ul class="dropdown-menu">
                        ...
                        <li><a style="font-size:15px" href="{{ URL::to('advices/') }}" class="{{classActivePathPublic('advices')}}">Советы эксперта</a>
                        <li><a style="font-size:15px" href="{{ URL::to('about-us/') }}" class="{{classActivePathPublic('about-us')}}">О нас</a></li>
                        <li><a style="font-size:15px" href="{{ URL::to('design/') }}" class="{{classActivePathPublic('design')}}">Строительство и дизайн</a></li>
                        <li><a style="font-size:15px" href="{{ URL::to('contact-us/') }}" class="{{classActivePathPublic('contact-us')}}">Контакты</a></li>
{{-- <li class="dropdown">

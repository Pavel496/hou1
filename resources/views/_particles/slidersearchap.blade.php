...
<!-- Property Search Box -->
  <section id="property-search-container" class="container" style="margin-bottom: 0px;">
      <div class="property-search-form horizontal" style="background-color: WhiteSmoke;">
          {!! Form::open(array('url' => array('searchpropertiesap'),'class'=>'','name'=>'search_form','id'=>'search_form','role'=>'form')) !!}
          <div class="main-search-sec">


            <div class="col-xs-2 col-sm-1 search-field">
              <p>Количество<wbr>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;комнат</p>
            </div>
            <div class="col-xs-2 col-sm-1 search-field">
                <select name="rangemin">
                <option value="1" @if(old('rangemin', $data['rangemin'])=='1') selected @endif> min </option>
                <option value="2" @if(old('rangemin', $data['rangemin'])=='2') selected @endif> 2 </option>
                <option value="3" @if(old('rangemin', $data['rangemin'])=='3') selected @endif> 3 </option>
                <option value="4" @if(old('rangemin', $data['rangemin'])=='4') selected @endif> 4 </option>
                <option value="5" @if(old('rangemin', $data['rangemin'])=='5') selected @endif> 5 </option>
                <option value="6" @if(old('rangemin', $data['rangemin'])=='6') selected @endif> 6 </option>
                <option value="7" @if(old('rangemin', $data['rangemin'])=='7') selected @endif> 7 </option>
                <option value="8" @if(old('rangemin', $data['rangemin'])=='8') selected @endif> 8 </option>
                <option value="9" @if(old('rangemin', $data['rangemin'])=='9') selected @endif> 9 </option>
                <option value="10" @if(old('rangemin', $data['rangemin'])=='10') selected @endif> 10 </option>
                <option value="11" @if(old('rangemin', $data['rangemin'])=='11') selected @endif> 11 </option>
              </select>
            </div>
            <div class="col-xs-2 col-sm-1 search-field">
              <select name="rangemax">
                <option value="300" @if(old('rangemax', $data['rangemax'])=='300') selected @endif> max </option>
                <option value="2" @if(old('rangemax', $data['rangemax'])=='2') selected @endif> 2 </option>
                <option value="3" @if(old('rangemax', $data['rangemax'])=='3') selected @endif> 3 </option>
                <option value="4" @if(old('rangemax', $data['rangemax'])=='4') selected @endif> 4 </option>
                <option value="5" @if(old('rangemax', $data['rangemax'])=='5') selected @endif> 5 </option>
                <option value="6" @if(old('rangemax', $data['rangemax'])=='6') selected @endif> 6 </option>
                <option value="7" @if(old('rangemax', $data['rangemax'])=='7') selected @endif> 7 </option>
                <option value="8" @if(old('rangemax', $data['rangemax'])=='8') selected @endif> 8 </option>
                <option value="9" @if(old('rangemax', $data['rangemax'])=='9') selected @endif> 9 </option>
                <option value="10" @if(old('rangemax', $data['rangemax'])=='10') selected @endif> 10 </option>
                <option value="11" @if(old('rangemax', $data['rangemax'])=='11') selected @endif> 11 </option>
              </select>
            </div>

            <div class="col-xs-5 col-sm-3 search-field">
                <input type="text" placeholder="Станция Метро (можно часть) {{ old('keyword') }}" name="keyword" id="keyword" style="margin-bottom: 0px;border:1px solid #d4d4d4;border-bottom-color: darkgreen">
            </div>
            <div class="col-xs-5 col-sm-2 search-field">
              <select id="proeprty-type" name="direction">
                <option value="17" selected> Москва </option>
            ...
            <div class="col-xs-4 col-sm-2 search-field">
                <select id="proeprty-type" name="type">
                  ...
                  @elseif ($page=='Продажа')
                    ...
                    <div class="col-xs-2 col-sm-1 search-field">
                        <a href="/apartment/sale" class="btn" role="button">Сброс</a>
                    </div>
                  @else
                    <input id="property_purpose" name="purpose" type="hidden" value="Аренда">
                    <div class="col-xs-2 col-sm-1 search-field">
                        <a href="/apartment/rent" class="btn" role="button">Сброс</a>
                    </div>
                  @endif
          ...
          <div class="col-xs-2 col-sm-1 search-field">
            <select name="landmin">
              <option value="1" @if(old('landmin', $data['landmin'])=='1') selected @endif> min </option>
              <option value="2" @if(old('landmin', $data['landmin'])=='2') selected @endif> 2 </option>
              <option value="3" @if(old('landmin', $data['landmin'])=='3') selected @endif> 3 </option>
              <option value="4" @if(old('landmin', $data['landmin'])=='4') selected @endif> 4 </option>
              <option value="5" @if(old('landmin', $data['landmin'])=='5') selected @endif> 5 </option>
              <option value="6" @if(old('landmin', $data['landmin'])=='6') selected @endif> 6 </option>
              <option value="7" @if(old('landmin', $data['landmin'])=='7') selected @endif> 7 </option>
          ...
          <div class="col-xs-2 col-sm-1 search-field">
            <select name="landmax">
              <option value="30" @if(old('landmax', $data['landmax'])=='30') selected @endif> max </option>
              <option value="2" @if(old('landmax', $data['landmax'])=='2') selected @endif> 2 </option>
              <option value="3" @if(old('landmax', $data['landmax'])=='3') selected @endif> 3 </option>
              <option value="4" @if(old('landmax', $data['landmax'])=='4') selected @endif> 4 </option>
              <option value="5" @if(old('landmax', $data['landmax'])=='5') selected @endif> 5 </option>
              <option value="6" @if(old('landmax', $data['landmax'])=='6') selected @endif> 6 </option>
              <option value="7" @if(old('landmax', $data['landmax'])=='7') selected @endif> 7 </option>
              {{-- <option value="7" @if(old('landmax', $data['landmax'])=='35') selected @endif> 35 </option>
          ...
          <div class="col-xs-4 col-sm-2 search-field">
            <select name="buildmin">
              <option value="0" @if(old('buildmin', $data['buildmin'])=='0') selected @endif>Площадь min (м2)</option>
          ...
          <div class="col-xs-4 col-sm-2 search-field">
            <select name="buildmax">
              <option value="3000" @if(old('buildmax', $data['buildmax'])=='3000') selected @endif>Площадь max (м2)</option>

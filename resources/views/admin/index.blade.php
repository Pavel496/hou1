...
<div id="main">
    ...
    <div class="col-md-4 col-md-offset-4">
        <div class="login" style="width: 79%">
            ...
            <div class="logo" href="#" align="" style="height: 90px;">

            <a href="{{ URL::to('/') }}"><img src="{{ URL::asset('upload/key2.png') }}" alt="logo" style="width: 95%;"></a>
            </div>
                        ...
                        <div class="form-group margin-none">
                            <div class="media">
                                ...
                                <div class="media-right media-middle">
                                    <a href="{{ URL::to('password/email') }}" class="small pull-right">Forgot?</a>
                                </div>
                            </div>
